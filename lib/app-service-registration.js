 ...
 * @param {Array.<String>} protocols The protocols
 */
AppServiceRegistration.prototype.setProtocols = function(protocols) {
    this.protocols = protocols;
};

/**
 * Get the list of protocols that this appservice will serve for third party lookups.
 * @return {Array.<String>} The protocols.
 */
AppServiceRegistration.prototype.getProtocols = function() {
